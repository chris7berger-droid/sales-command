...
console.log('PASS: day/trip coworkers, override/inheritance, Sunday/DST, deferred start, missing jobs, board lead on unlinked days, duplicate/multiple assignments, internal note exclusion')
