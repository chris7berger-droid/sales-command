...
try {
  ...
  assert.match(text,/CREW[\s\S]*6618 — Final Burnish[\s\S]*Kurtis Zomparelli/)
  ...
  assert.match(await preview.inputValue(),/CREW[\s\S]*JoseJR/)
  assert.doesNotMatch(await preview.inputValue(),/With:/)
