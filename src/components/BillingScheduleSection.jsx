    ...
    <div style={card}>
      ...
      {payApps.length > 0 && (
        <div style={{ marginTop: 18 }}>
          ...
          <div style={{ border: `1px solid ${C.border}`, borderRadius: 8, overflow: "hidden" }}>
            <div style={{ display: "grid", gridTemplateColumns: "60px 1fr 120px 120px 120px 120px 90px", background: C.dark, padding: "8px 12px", gap: 10 }}>
            ...
            {payApps.map(pa => (
              <div key={pa.id} onClick={() => setDetailPayAppId(pa.id)} style={{ display: "grid", gridTemplateColumns: "60px 1fr 120px 120px 120px 120px 90px", padding: "8px 12px", gap: 10, borderTop: `1px solid ${C.border}`, alignItems: "center", background: C.linenLight, cursor: "pointer" }}>
                ...
                <div style={{ textAlign: "center" }}>
                  <span style={{ fontSize: 10, fontWeight: 700, color: C.teal, fontFamily: F.display, letterSpacing: "0.05em", textTransform: "uppercase", background: C.dark, padding: "3px 9px", borderRadius: 4 }}>View Data</span>
                </div>
              </div>
            ))}
          </div>
