    ...
    pages: [
      ...
      { pg: "4.2", screen: "Invoice Detail", id: "invoices:detail",
        ...
        features: [
          ...
          { label: "Sync and Send button", desc: "Push an existing invoice to QuickBooks after the fact. Appears for invoices that haven't been pushed to QB yet — typically when the underlying job was linked to a QB customer AFTER the invoice was created. If the invoice is Paid, the payment is also recorded in QB automatically.",
            steps: ["1. Open an invoice that wasn't pushed to QuickBooks", "2. Confirm the underlying job is linked (LINKED chip on the call log)", "3. Tap 'Sync and Send'", "4. A toast appears with the new QB invoice ID", "5. If the invoice was Paid, payment is recorded in QB as well"] },
  ...
  },
  {
    ...
    pages: [
      { pg: "5.1", screen: "Goals & Pipeline", id: "dashboard",
        desc: "The big picture — monthly and yearly billing goals, conversion rate, and how many proposals you've sent. Click any goal card to see the details behind the number. Dashboard numbers include all jobs (Active and Old) so your totals are always accurate.",
        features: [
