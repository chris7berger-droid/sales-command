...
export default function Archive({ userRole }) {
  ...
  return (
    <div>
      ...
      {tab === "search" && <ArchiveSearchView tenantId={tenantId} onNavigateProposal={id => navigate(`/sales/proposals/${id}`)} canImport={["Admin", "Manager", "Sales Rep"].includes(userRole)} onDetailChange={setViewingDetail} />}
