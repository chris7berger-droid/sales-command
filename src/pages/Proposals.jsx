  ...
  useEffect(() => {
    ...
    (async () => {
      const { data } = await supabase
        .from("proposals")
        .select("*, call_log(jobsite_address, jobsite_city, jobsite_state, jobsite_zip, display_job_number, customer_name, sales_name, job_name, customer_id, show_cents, qb_skip_sync, qb_customer_id, archive_record_id, deposit_required, deposit_amount, customers(email, contact_email, business_address, business_city, business_state, business_zip))")
