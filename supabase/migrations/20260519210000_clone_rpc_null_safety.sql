-- Fix clone_proposal_to_gcs: viewer_contact_ids null safety
-- JSON null (from JS null) passes IS NOT NULL but crashes jsonb_array_length.
-- Switch to jsonb_typeof guard.
